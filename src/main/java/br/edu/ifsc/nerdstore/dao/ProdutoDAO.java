...
public class ProdutoDAO extends DAO<Produto> {
	...
	static {
		PRODUTOSDEMO.add(new Produto("Porta café R2-D2",
				"https://www.thinkgeek.com/images/products/frontsquare/itns_r2-d2_coffee_press.jpg",
				new BigDecimal(99.99)));
		PRODUTOSDEMO.add(new Produto("Chaveiro HULK",
				"https://www.thinkgeek.com/images/products/frontsquare/jgvo_marvel_hulk_ornament.jpg",
				new BigDecimal(55.99)));
		PRODUTOSDEMO.add(new Produto("Chaveiro DALEK",
				"https://www.thinkgeek.com/images/products/frontsquare/jhkg_doctor_who_dalek_ornament.jpg",
				new BigDecimal(7.88)));
		PRODUTOSDEMO.add(new Produto("Caneca Yoda",
				"http://www.thinkgeek.com/images/products/frontsquare/ilgs_sw_yoda_heat_change_mug.gif",
				new BigDecimal(80)));
		PRODUTOSDEMO.add(new Produto("Caderno Dragon Ball",
				"http://www.thinkgeek.com/images/products/frontsquare/jltp_dragon_ball_z_journal.jpg",
				new BigDecimal(30.50)));
		PRODUTOSDEMO.add(new Produto("Fallout BoobleHead",
				"http://www.thinkgeek.com/images/products/frontsquare/1af2_fallout_bobbleheads.jpg",
				new BigDecimal(9.50)));
	}
